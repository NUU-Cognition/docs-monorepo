...
- Consistent tracking with [Connections](/modules/connections) (which uses the same pattern)
...
- [Module - Connections](/modules/connections) - Similar declaration + fulfillment pattern for connecting to other Flints
- [Reference - Configuration](/reference/configuration) - Workspace section in flint.toml
- [Reference - CLI Commands](/reference/cli-commands) - Workspace CLI commands
