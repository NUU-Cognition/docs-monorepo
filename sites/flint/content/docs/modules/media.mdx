...
![Media/diagrams/architecture.png](/media-diagrams-architecture-png)

See the specification:
![Media/references/specification.pdf](/media-references-specification-pdf)

Listen to the discussion:
![Media/recordings/meeting.mp3](/media-recordings-meeting-mp3)
```
...
```markdown
![500](/media-diagram-png)        # 500px width
![300x200](/media-diagram-png)    # Explicit dimensions
```
...
```markdown
![Media/diagram.png](/media-diagram-png)    # Shows the image
[Media/diagram.png](/media-diagram-png)     # Links to the file
```
...
![Media/diagrams/three-layer.png](/media-diagrams-three-layer-png)
...
- [Module - Mesh](/modules/mesh) - Notes that embed media assets
- [Module - Exports](/modules/exports) - Media references in compiled exports
- [Module - Workspace](/modules/workspace) - For code, use Workspace not Media
