...
Making AI systems that accept correction.
...
Media/
├── papers/
│   ├── bostrom-2014-excerpt.pdf
│   └── russell-2019-ch1.pdf
└── diagrams/
...
```markdown
See the original paper: ![Media/papers/bostrom-2014-excerpt.pdf](/media-papers-bostrom-2014-excerpt-pdf)
