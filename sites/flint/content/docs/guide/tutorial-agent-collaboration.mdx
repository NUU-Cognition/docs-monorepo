...
This installs shards for structured work and the Claude Code mod for tool integration.
...
Codebase linked at [Workspace/References/rf-monorepo](/workspace-references-rf-monorepo)
```
...
The agent will:
1. Read the Projects shard init file
...
- [Module - Shards & Mods](/modules/shards-mods) - Deep dive into available shards
