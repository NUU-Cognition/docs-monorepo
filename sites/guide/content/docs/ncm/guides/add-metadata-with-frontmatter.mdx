...
- You know that frontmatter is optional in the default NCM preset. The strict preset requires it. See [Presets and Extensions](/ncm/concepts/presets-and-extensions).
...
There is at most one frontmatter block. It is always first. Its identity is the fixed value `frontmatter`. It does not take a positional `b1` slot. See [Block Identity](/ncm/concepts/block-identity).
