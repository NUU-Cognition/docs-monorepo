...
- You know the default NCM preset. See [Concept - Presets and Extensions](/ncm/concepts/presets-and-extensions).
- You know what promotion does. See [Concept - Promotion](/ncm/concepts/promotion).
...
Keep custom fields flat. See [Guide - Add Metadata with Frontmatter](/ncm/guides/add-metadata-with-frontmatter).
...
Do not add an anchor to every block. Headings already get slugs. Use anchors for paragraphs and lists that must stay findable. See [Concept - Block Identity](/ncm/concepts/block-identity).
