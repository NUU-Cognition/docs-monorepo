...
A published version of a whole mesh is a different idea. See [Concept - Published Versions](/mesh/concepts/published-versions).

## Prerequisites

- You can edit the mesh.
- You know that a title is identity. See [Concept - Core Ideas](/mesh/concepts/core-ideas).
