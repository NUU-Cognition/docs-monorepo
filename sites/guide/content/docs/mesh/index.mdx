...
You need a NUU account to edit a mesh. You can read a published version without an account. See [Published Versions](/mesh/concepts/published-versions).
...
You publish a version when you want a frozen copy that anyone can open. The live mesh stays editable. The published version does not. See [Publish a Version](/mesh/workflows/publish-a-version).
...
Edits go to the service as batches. If the document changed elsewhere, the batch does not apply. You choose which copy to keep. See [Understand Versions and Conflicts](/mesh/workflows/understand-versions-and-conflicts).
