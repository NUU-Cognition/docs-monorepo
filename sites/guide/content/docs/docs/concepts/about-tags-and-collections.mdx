...
A tag is a label. A collection is a group. You can use both on the same document. See [Concept - Core Ideas](/docs/concepts/core-ideas) for the short definitions.
...
- [Guide - How to Upload and Parse a Document](/docs/guides/how-to-upload-and-parse-a-document)
