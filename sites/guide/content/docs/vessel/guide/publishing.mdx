...
- [Reference - Blog Options](/vessel/templates/blog-options) — dates, authors, featured posts, sorting, sidebar
- [Reference - Project Options](/vessel/templates/project-options) — status, milestones, updates, scope, sections with icons
- [Reference - Whitepaper Options](/vessel/templates/whitepaper-options) — audience variants, table of contents, timeline, version badges
