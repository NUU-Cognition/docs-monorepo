...
- [Getting Started](/vessel/guide/getting-started) — Install the CLI and publish your first vessel
- [Publishing](/vessel/guide/publishing) — Vessel definitions, content references, media, and visibility
- [Reference - Blog Options](/vessel/templates/blog-options) — Blog template configuration
- [Reference - Project Options](/vessel/templates/project-options) — Project template configuration
- [Reference - Whitepaper Options](/vessel/templates/whitepaper-options) — Whitepaper template configuration
