...
**Workspace.** A workspace is the place you work. It is either personal, or it is an organisation you belong to. See [About Workspaces](/operations/concepts/about-workspaces).

**Project.** A project is the top container in a workspace. It holds deliverables and a project backlog.

**Deliverable.** A deliverable is a scoped chunk of work inside a project. Its state comes from its subsections, not from a manual status you type in. See [About Deliverables](/operations/concepts/about-deliverables).
...
**Task.** A task is one unit of work. It can sit in the master backlog, in a project backlog, or in a subsection. It has a state of to do, doing, or done. See [About Tasks and Backlogs](/operations/concepts/about-tasks-and-backlogs).
...
**Strike.** A strike is a personal target. Strikes are yours. They are not shared with a team. See [Run Your Day with Strikes](/operations/workflows/run-your-day-with-strikes).
...
- [About Workspaces](/operations/concepts/about-workspaces)
- [About Deliverables](/operations/concepts/about-deliverables)
