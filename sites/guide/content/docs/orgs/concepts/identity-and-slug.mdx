...
On a team organisation, an admin can change the display name. The admin can also change the tagline, description, picture, and other public fields. See [Public Pages](/orgs/concepts/public-pages).
...
- [Public Pages](/orgs/concepts/public-pages)
- [Introduction](/orgs)
