...
Read [Keep a Description as a File](/citations/workflows/keep-a-description-as-a-file) to use the command line tool. Read [Core Ideas](/citations/concepts/core-ideas) for what a Description is.
