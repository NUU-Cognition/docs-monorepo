...
This declares the other Flint’s built export as a source bundle and materializes it under `Sources/Bundles/`.
...
- write `Exports/(Bundle) <Name>/` with `Mesh/`, `Media/`, and `_manifest.json`
