...
1. [Quick Start](/flint/guide/quick-start)
2. [Core Concepts](/flint/guide/core-concepts)
3. [Creating a Flint](/flint/guide/creating-a-flint)

If you already understand the basic model and want to do real work:

- [Tutorial Project Planning](/flint/guide/tutorial-project-planning)
- [Tutorial Research Notes](/flint/guide/tutorial-research-notes)
- [Tutorial Agent Collaboration](/flint/guide/tutorial-agent-collaboration)
